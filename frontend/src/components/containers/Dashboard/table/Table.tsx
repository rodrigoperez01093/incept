...
const Table:React.FC = () => {
  ...
  return (
    <>
        ...
        <table className='min-w-[600px] w-full h-full border border-incept-black mb-2 xs:mt-2 2xl:mt-0 text-center overflow-y-hidden relative'>
            <thead>
                                ...
                                <td className='border border-incept-primary w-[150px] h-full'>
                                    <div className='flex flex-row items-center justify-center'>
                                        <svg className='mr-2' width="20" height="20" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <rect x="1" y="3" width="26" height="20" rx="3" stroke="#828282" strokeWidth="2" strokeLinejoin="round"/>
                                            <path d="M7 1V5" stroke="#828282" strokeWidth="2" strokeLinecap="round"/>
                                            <path d="M21 1V5" stroke="#828282" strokeWidth="2" strokeLinecap="round"/>
                                            ...
                                            <path d="M1 6C1 4.34315 2.34315 3 4 3H24C25.6569 3 27 4.34315 27 6V8H1V6Z" stroke="#828282" strokeWidth="2"/>
                                        </svg>
                                        {row.last_updated}
                                    </div>
                                </td>
                                ...
                                <td className='border border-incept-primary w-[150px] h-full mx-1'>
                                    <span className='flex flex-row items-center justify-center'>
                                        <svg className='mr-2' width="18" height="18" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="12.4612" cy="12" r="11.0769" stroke="#828282" strokeWidth="1.77231"/>
                                            <path d="M12.4614 3.1384V1.36609" stroke="#828282" strokeWidth="1.77231" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M12.4614 22.1908V20.4185" stroke="#828282" strokeWidth="1.77231" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M21.3229 12L23.0952 12" stroke="#828282" strokeWidth="1.77231" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M2.27066 12L4.04297 12" stroke="#828282" strokeWidth="1.77231" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M18.7277 5.73405L19.981 4.48083" stroke="#828282" strokeWidth="1.77231" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M5.25558 19.206L6.50879 17.9528" stroke="#828282" strokeWidth="1.77231" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M18.7277 18.266L19.981 19.5192" stroke="#828282" strokeWidth="1.77231" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M5.25558 4.79403L6.50879 6.04724" stroke="#828282" strokeWidth="1.77231" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M12.4614 6.23999V12H16.4491" stroke="#828282" strokeWidth="1.77231" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                        {row.case_duration}
                                    </span>
                                </td>
